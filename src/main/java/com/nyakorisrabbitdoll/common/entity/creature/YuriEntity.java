...
public class YuriEntity extends EntityTameable {
    ...
    public YuriEntity(World worldIn) {
        super(worldIn);
    ...
    protected void applyEntityAttributes() {
        ...
        this.getAttributeMap().registerAttribute(SharedMonsterAttributes.ATTACK_DAMAGE).setBaseValue(19.0D);
    }
    ...
    public boolean shouldAttackEntity(EntityLivingBase target, EntityLivingBase owner)
    {
        ...
        {
            if (target instanceof YuriEntity)
            {
                YuriEntity yuri = (YuriEntity) target;

                if (yuri.isTamed() && yuri.getOwner() == owner)
                {
                    return false;
                }
            }
