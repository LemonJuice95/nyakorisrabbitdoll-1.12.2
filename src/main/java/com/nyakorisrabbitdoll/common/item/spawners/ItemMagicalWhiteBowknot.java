...
public class ItemMagicalWhiteBowknot extends NItemBase {
    public ItemMagicalWhiteBowknot() {
        super("magical_white_bowknot");
    }
    ...
    public EnumActionResult onItemUse(EntityPlayer player, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
        ...
        if(!worldIn.isRemote) {
            NyakoriEntity entity = new NyakoriEntity(worldIn);
